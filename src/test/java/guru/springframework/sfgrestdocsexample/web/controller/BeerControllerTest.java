...
//  pay attention on static import. This is point.
// If MockMvcRequestBuilders is used then RestDocumentationRequestBuilders will failed
                ...
                .andDo(document("v1/beer",
                        pathParameters(
                                parameterWithName("beerId")
                                        .description("UUID of beer to get")
                        )
                    )
                );
    }
